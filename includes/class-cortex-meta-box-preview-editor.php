...
/**
 * The meta box that shows a preview editor.
 * @class CortexMetaBoxPreviewEditor
 * @since 0.1.0
 */
class CortexMetaBoxPreviewEditor extends CortexMetaBox {
	...
	protected function template() {
		return 'cortex-meta-box-preview-editor.twig';
	}
